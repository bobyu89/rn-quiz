...
const merged = readJSON(workFile('exp-merged.json'), '請先執行 node tools/merge-exp.js');

const TODO = workDir('todo');
...
fs.writeFileSync(workFile('todo-index.json'), JSON.stringify(index, null, 1));
